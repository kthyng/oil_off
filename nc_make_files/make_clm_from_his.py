...
def make_clm(input_file, output_name):
    ...
    keep = ['ocean_time', 'zeta', 'ubar', 'vbar', 'u', 'v', 'w', 'omega', 'temp', 'salt', 'swrad', 'shflux']
...
if __name__ == '__main__':
    ...
    files = sorted(glob.glob('../../oil_03/oil_03_ocean_his_000*.nc'))
    make_clm(input_file=files, output_name='../INPUT/oil_clm_off.nc')
