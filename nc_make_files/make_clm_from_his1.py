...
def make_clm(input_file, output_name):
    ...
    if nfiles==1:
        ds = xr.open_dataset(input_file[0], decode_times=False)
    elif nfiles>1:
...
if __name__ == '__main__':
    ...
    files = sorted(glob.glob('../../oil_03/output_LeftGaussian/3hrs/oil_03_ocean_his*'))
    make_clm(input_file=files, output_name='../clm/oil_clm_his_3hrs.nc')
